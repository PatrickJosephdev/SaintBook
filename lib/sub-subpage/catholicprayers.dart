  ...
  Future<void> _fetchUrl() async {
    try {
      final response = await http.get(Uri.parse(
          'https://patrickjosephdev.github.io/Book_of_Saints/prayerurl.json'));
      if (response.statusCode == 200) {
        final jsonData = json.decode(response.body);
        if (jsonData['url'] != null && jsonData['url'].isNotEmpty) {
          setState(() {
            _url = jsonData['url'].trim();
          });
          _loadWebView();
        } else {
...
//     try {
//       final response = await http.get(Uri.parse(
//           'https://patrickjosephdev.github.io/Book_of_Saints/prayerurl.json')); // Replace with your GitHub JSON URL
//       if (response.statusCode == 200) {
//         final jsonData = json.decode(response.body);
//         if (jsonData['url'] != null && jsonData['url'].isNotEmpty) {
//           setState(() {
